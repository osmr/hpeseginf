"""
    Script for demonstration of HPE-Seg task solving on a video.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="HPE-Seg on a video",
...
def cv_plot_keypoints(image,
    ...
    for pts_i, scores_i in zip(pts, scores):
...
def main():
    ...
    for i in range(max_num_frames):
        ...
        pts0, scores0 = _calc_pts_from_heatmap(output[:, 1:])
